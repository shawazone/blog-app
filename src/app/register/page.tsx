...
export default function page() {
  ...
  return (
    <form onSubmit={onSubmit} className='text-center'>
        ...
        <InputFeild placeholder='Name' id='name' type='text' name='name' onChange={handleChange} value={state.name}/>
        <InputFeild placeholder='Email' id='email' type='email' name='email' onChange={handleChange} value={state.email}/>
        <InputFeild placeholder='Password' id='password' type='password' name='password' onChange={handleChange} value={state.password}/>
